...
public class PostItem {
    ...
    public PostItem(int itemNum, String userName, boolean isUserLike, int postLikeCount, String postImgUrl, String postText, JSONObject likeCheck, String picName) {
